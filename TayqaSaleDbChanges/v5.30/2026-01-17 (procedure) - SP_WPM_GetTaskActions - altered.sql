CREATE Or alter proc [dbo].[SP_WPM_GetTaskActions] @firm smallint, @userId bigint, @notConsiderDeletedTasksDate datetime, @taskId int = null
AS
BEGIN
    ...
    select Task.Id                          as TaskId,
           ...
           TaskAction.NonActionReasonsEnabled,
           TaskAction.NonActionReasonInputType,
           TaskAction.NonActionReasonNoteEnabled,
           TaskAction.StartActionGroupId       TaskActionStartActionGroupId,
           TaskAction.ConditionalVisibility as ConditionalVisibility

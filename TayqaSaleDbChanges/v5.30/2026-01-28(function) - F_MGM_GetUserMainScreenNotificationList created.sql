CREATE OR ALTER FUNCTION [dbo].[F_MGM_GetUserMainScreenNotificationList](@userId BIGINT)
    RETURNS TABLE
        AS
        RETURN(SELECT top 10000000000 n.Id
                                    , n.Name                 Header
               ...
               WHERE nu.UserId = @userId
                 ...
                 and ncdl.Id is null
                 and (nc.Id IS NULL OR nc.IsActive = 1)

...
ALTER FUNCTION [dbo].[F_CHL_GetUserSurveyApproveReport](@pointType TINYINT)
    RETURNS TABLE
        ...
        RETURN(SELECT Response.Id,
                      ...
                      dbo.F_CHL_CalculateMaxPointForSurveyByDate(Response.SurveyId, Response.SavedDate, @pointType) SurveyMaxPoint,
               ...
               FROM CHL_UserSurveyResponse Response with (nolock)
                        ...
                        JOIN MD_Client Client with (nolock) ON Client.Firm = Response.Firm AND Client.TigerId = Response.ClientId
                        ...
                        JOIN F_CHL_CalculateUserSurveyPoints(@pointType) UserPoint ON UserPoint.ReportId = Response.Id)
...
CREATE PROCEDURE [dbo].[SP_OP_GetThirdPartyInvoices]
	@firm smallint,
	@startDate datetime,
	@endDate datetime,
    ...
    SET @sql = '
        ...
        WITH MainData AS (
            SELECT
                ...
                CASE
                    WHEN ilog.ProcessingStatus = 1 THEN 0
                    WHEN SUM(line.Amount - lineResult.Amount) = 0 THEN 2
                    WHEN SUM(lineResult.Amount) = 0 THEN 3
                    ELSE 4
                END AS Status,
                ...
                SUM(line.Price * line.Amount) AS TotalAmount
            FROM
	...
	SET @sql = @sql + '
	 ...
	 SELECT
                ...
                CASE
                    ...
                    WHEN SUM(lineResult.Quantity) = 0 THEN 3
                    ELSE 4
                END AS Status,
                ilog.DocCreatedTime AS DocCreatedTime,
                firm.Name AS FirmName,

...
BEGIN
	...
	left join MD_ItemUnit unit with(nolock) on unit.Code=promo.PromoItemUnitCode and unit.TigerItemId=promo.PromoValue and promo.PromoType=1 and unit.Firm=cm.Firm

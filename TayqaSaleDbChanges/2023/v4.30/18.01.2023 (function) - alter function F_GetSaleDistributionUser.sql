    ...
    @itemGroupType smallint
              ...
              (
                  ...
                  from (select Target.UserId,
                               ...
                               Month,
                               Year,
                             IIF ( cast((TargetClientPercent * CGCC.ClientCount / 100) as int)>0,  FactClientCount * 100 /cast((TargetClientPercent * CGCC.ClientCount / 100) as int) , 0 ) as FactClientPercent

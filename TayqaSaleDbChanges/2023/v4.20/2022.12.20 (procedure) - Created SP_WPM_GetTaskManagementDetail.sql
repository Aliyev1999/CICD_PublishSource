create PROCEDURE [dbo].[SP_WPM_GetTaskManagementDetail] @userId INT, @startDate DATE, @endDate DATE
AS
BEGIN
...
-- Query: returns the result of tasks and statuses for Management module in TayqaSale
    ...
    select Tasks.Id                                           as TaskId,
           taskdata.TaskCLientId                              as TaskClientId,
    ...
    from taskdata
             ...
             join WPM_Task Tasks with (nolock) on tasks.Id = taskdata.TaskId

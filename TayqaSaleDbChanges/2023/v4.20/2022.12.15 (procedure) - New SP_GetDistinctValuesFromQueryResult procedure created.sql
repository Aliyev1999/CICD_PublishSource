...
/****** Object:  StoredProcedure [dbo].[SP_GetDistinctValuesFromQueryResult]    Script Date: 12/15/2022 5:13:39 PM ******/

CREATE OR ALTER procedure [dbo].[SP_GetDistinctValuesFromQueryResult] @query nvarchar(max) as
begin

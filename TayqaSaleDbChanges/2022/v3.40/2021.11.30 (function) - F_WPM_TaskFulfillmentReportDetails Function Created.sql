alter FUNCTION [dbo].[F_WPM_TaskFulfillmentReportDetails]() 
Returns Table
AS
RETURN(
    SELECT
...
LEFT JOIN WPM_TaskTicket TaskTicket ON TaskTicket.ClientId = TaskClient.ClientId AND TaskTicket.TaskId = TaskClient.TaskId AND TaskTicket.UserId = UserTask.UserId

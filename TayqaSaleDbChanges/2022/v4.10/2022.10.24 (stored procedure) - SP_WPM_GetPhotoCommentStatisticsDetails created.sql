create procedure [dbo].[SP_WPM_GetPhotoCommentStatisticsDetails](@clientCodeOrName nvarchar(50) null,
...
-- Created by TayqaTech for TayqaSale (back-end) on 20.10.2022
-- Description: The query returns details for a selected client and comment in WPM

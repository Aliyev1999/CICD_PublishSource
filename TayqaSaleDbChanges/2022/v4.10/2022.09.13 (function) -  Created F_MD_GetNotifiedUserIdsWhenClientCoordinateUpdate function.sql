CREATE function [dbo].[F_MD_GetNotifiedUserIdsWhenClientCoordinateUpdate](@firm smallint, @clientIds nvarchar(max), @currentUserId bigint)
    returns table
        as
        return
        select PermittedClients.Firm     as Firm,
               PermittedClients.UserId   as UserId,

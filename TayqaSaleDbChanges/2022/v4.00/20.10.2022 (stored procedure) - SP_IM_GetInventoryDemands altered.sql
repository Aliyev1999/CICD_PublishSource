...
with Data as (select Demands.Id                                          as Id,
                     ...
                     cast(1 as bit)										 as IsDeliveryRequired,
...
'
    ...
    if @creatorUserSpecodes is not null
        set @sql = concat(@sql,
                          ' and (CreatorUserSpecode1 like ''%''+@creatorUserSpecodes+''%'' or CreatorUserSpecode2 like ''%''+@creatorUserSpecodes+''%'' or CreatorUserSpecode3 like ''%''+@creatorUserSpecodes+''%'')')

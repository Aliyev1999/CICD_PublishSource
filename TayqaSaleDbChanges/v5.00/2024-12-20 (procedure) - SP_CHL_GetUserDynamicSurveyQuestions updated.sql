ALTER procedure dbo.SP_CHL_GetUserDynamicSurveyQuestions @surveyId int, @clientId int, @UserId int
as
begin
    select distinct cast(0 as bit)      as IsAnswerRequired,
                    cast(1 as tinyint)  as QuestionType,
                    cast(0 as smallint) as QuestionOrderNumber,
                    null                as QuestionName,
                    null                as QuestionCode,
                    null                as QuestionDescription,

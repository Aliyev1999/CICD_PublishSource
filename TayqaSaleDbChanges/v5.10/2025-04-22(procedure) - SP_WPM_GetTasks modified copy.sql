...
/****** Object:  StoredProcedure [dbo].[SP_WPM_GetTasks]    Script Date: 4/22/2025 1:52:28 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER proc [dbo].[SP_WPM_GetTasks] @firm smallint, @userId bigint, @notConsiderDeletedTasksDate datetime, @taskId int = null
AS
BEGIN
    ...
    select distinct Task.Id                                   as Id,
					...
					Task.OneClientAtTime					  as OneClientAtTime,
					Task.AllowedManualClientVisitCount		  as AllowedManualClientVisitCount,
					...
					Task.TaskFinishControl				      as TaskFinishControl,
					Task.HasOnlineActions				      as HasOnlineActions,
                    0                                         as OrderNo,

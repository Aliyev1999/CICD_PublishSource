create or ALTER function [dbo].[F_MGM_GetUserUnReadNotificationList] ( @firm Smallint, @userId bigint)
    returns table
        as
        return(select notification.Id,
               ...
               where notificationUser.UserId = @userId and notification.firm=@firm

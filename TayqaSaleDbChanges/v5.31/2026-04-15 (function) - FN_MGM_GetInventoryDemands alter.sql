create or ALTER function [dbo].[FN_MGM_GetInventoryDemands](	@firm Smallint,
    @userId int,
    @beginDate datetime,
    @endDate datetime,
    @isCompleted bit
    ...
    returns table
        ...
        return(
               ...
               where ((@isCompleted = 0 and DemandStatus = 0)
                   ...
                   and ((@beginDate is null or  @endDate is null ) or demand.CreationTime between @beginDate and @endDate) and demand.Firm=@firm

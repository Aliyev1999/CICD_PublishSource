create or ALTER FUNCTION [dbo].[F_MGM_GetRiskLimitRequestDetails]( @firm Smallint, @requestId INT)
RETURNS TABLE
AS
RETURN
(
    ...
    FROM 
        ...
        INNER JOIN MD_Client AS Client WITH (NOLOCK)
            ...
            AND Client.Firm = RiskLimitRequest.Firm and RiskLimitRequest.Firm=@firm
);

create or ALTER FUNCTION [dbo].[FN_MGM_GetRouteStatisticsEmployees](@firm Smallint,@beginDate datetime2, @endDate datetime2, @currentUserId bigint  )
    RETURNS TABLE
        AS
        RETURN(with TreeUsers as (select UserId
                    ...
                    Routes as (select Routes.UserId, Routes.TigerClientId as ClientId, Routes.Date
                               ...
                               where Routes.Date between @begindate and @enddate and Routes.Firm=@firm
                                 and Routes.Status = 0),
                    ...
                    Actions as (select Logs.UserId, Logs.ClientId, Logs.ProcessDate as Date
                                ...
                                where Logs.ProcessDate between @begindate and @enddate and Logs.Firm=@firm
                                ...
                                where Logs.CreatedDate between @begindate and @enddate and Logs.Firm=@firm

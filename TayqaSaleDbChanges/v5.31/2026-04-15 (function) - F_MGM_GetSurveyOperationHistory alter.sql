create or ALTER FUNCTION [dbo].[F_MGM_GetSurveyOperationHistory](@firm smallint,
    @UserId bigint,
    @ClientId bigint,
    @SurveyId int
...
select distinct survey.Name                      as SurveyName,
				...
				attach.AnswerAttachmentId as AnswerAttachmentId, --bu column backendden silindi evezine cavablara attach olunmuş şəkillərin Idsi gelmelidir AnswerAttachmentId
                attach.AnswerAttachmentURL as AnswerAttachmentUrl,--bu column backendden silindi evezine cavablara attach olunmuş şəkillərin Urli gelmelidir AnswerAttachmentUrl
...
--select * from F_MGM_GetSurveyOperationHistory(718,149479,8163)
--exec SP_MGM_GetClientTracking 604,'20250704'

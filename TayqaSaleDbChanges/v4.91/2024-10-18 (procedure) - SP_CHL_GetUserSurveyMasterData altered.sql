...
BEGIN
    ...
    with ActiveSurveys as (select distinct Survey.Id as SurveyId
    ...
    select UserSurveys.SurveyUserId as SurveyUserId,
           ...
           null                     as SalesmanCode,     -- istifade edilmir deye null gonderirik
           null                     as MerchandiserCode, -- istifade edilmir deye null gonderirik
           Survey.Firm              as Firm,
           ...
           null                     as SurveyTagId,      -- istifade edilmir deye null gonderirik
           null                     as SurveyTag         -- istifade edilmir deye null gonderirik

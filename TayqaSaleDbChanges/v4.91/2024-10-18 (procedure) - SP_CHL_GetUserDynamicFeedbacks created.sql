CREATE procedure [dbo].[SP_CHL_GetUserDynamicFeedbacks] @firm smallint, @userId bigint, @beginDate datetime, @endDate datetime
as
begin
    ...
    from CHL_UserSurveyResponse Response with (nolock)
             ...
             join CHL_UserSurveyResponseDetail Detail with (nolock) on Response.Id = Detail.UserSurveyResponseId
             ...
             left join CHL_UserSurveyResponseDetailReason Reason with (nolock) on Detail.Id = Reason.UserSurveyResponseDetailId

...
select distinct Files.Id                                           as Id,
				...
				case 
					when Survey.Code in (''12041'',''11530'') then concat(
				cast(Files.CreatedDate as nvarchar(max)),''_'',Survey.Name,''('',Survey.Code,'')'',''_'',Question.Name COLLATE SQL_Latin1_General_CP1_CI_AS
				,''('',Question.Code,'')'',''_'',''_'',Question.Description COLLATE SQL_Latin1_General_CP1_CI_AS ,isnull(Answer.Text,Details.AnswerValue))
				else null
				end as Label

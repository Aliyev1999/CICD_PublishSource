					...
					FROM Structure INNER JOIN MD_Salesman Salesmans
                          ...
                          INNER JOIN (SELECT datepart(MONTH, Response.SavedDate) Month,
                                          ...
                                          FROM CHL_UserSurveyResponse Response
                                                   LEFT JOIN F_CHL_CalculateUserSurveyPointsAll() UserPoints ON UserPoints.ReportId=Response.Id AND UserPoints.PointType=1
                                                   ...
                                                   LEFT JOIN F_CHL_CalculateSurveyMaxPointsAll() Mp ON Mp.SurveyId=sur.Id AND Mp.PointType=1

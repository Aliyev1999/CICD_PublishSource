CREATE FUNCTION [dbo].[FN_TS_Report_GetFinalizedItemExtract_XXX_YY](@clientId INT, @beginDate DATETIME, @endDate DATETIME)
    RETURNS TABLE
        AS RETURN
            (
                SELECT t.ItemCode, t.ItemName, t.GrossQuantity, t.ReturnQuantity, t.NetQuantity, t.PromoQuantity,
                       -- will be deprecated
                ...
                FROM (
                         SELECT ITEMS.CODE AS ItemCode, ITEMS.NAME AS ItemName,
                         ...
                         GROUP BY ITEMS.CODE, ITEMS.NAME) t
            )
GO
